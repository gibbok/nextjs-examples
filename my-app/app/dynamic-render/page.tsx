  ...
  return (
    <div className="">
      ...
      <ul className="list-disc ml-2">
        ...
        <li>
          Explicit configuration: You can explicitly set a route to be dynamic by using the `dynamic = 'force-dynamic'` option in the route segment config .
        </li>
        <li>
          Uncached data fetching: If you use `fetch()` requests without caching (e.g., `{cach`e: 'no-store' }`), this will trigger dynamic rendering .
        </li>
        <li>
